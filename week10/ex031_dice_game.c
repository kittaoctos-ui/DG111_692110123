...
// รับค าตอบจากผู ้เล่นแล้วเขียนลง *guess โดยตรง
...
// อ่านอย่างเดียว — const int* ป้องกันไม่ให้ฟังก์ชันนี ้แก้ *score โดยไม่ตั ้งใจ
void displayScore(const int *score)
{
    printf("Current score: %d\n", *score);
}

// ถามผู ้เล่นแล้วเขียนค าตอบ (เล่นต่อหรือไม่) ลง *keepPlaying โดยตรง
...
int main()
{
    ...
    int *pScore = &score; // pointer เดียวที ่ checkGuess และ displayScore ใช้ร่วมกันทุก round
