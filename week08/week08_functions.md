...
**คำตอบ:  ใน function ค่าตัวแปรไม่มีผลเปลี่ยนค่าใน main()**

### 2.2 `lerp` — Local Scope

**คำถาม:** ทำไม `main()` ถึงมองไม่เห็นตัวแปร `result` ทั้งที่มันถูกประกาศไว้ในไฟล์เดียวกัน?

**คำตอบ: เพราะตอนนี้อยู่ใน scope ของ main() ซึ่งไม่มีตัวแปรชื่อ result เลย**
...
**คำตอบ: ใน function ค่าตัวแปรไม่กระทบผลกับค่าตัวแปรใน main() dicemin กับ  min เป็นคนละตัวแปร**
...
**คำตอบ:** *current เป็นตัวแปรคนละตัวกับ score และได้รับเพียงสำเนาค่า score การแก้ curremt = 0 ใน precentOf จึงไม่เปลี่ยนscore  ในmain ได้*
